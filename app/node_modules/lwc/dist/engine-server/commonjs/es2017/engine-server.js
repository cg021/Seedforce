...
const BOOLEAN_ATTRIBUTES = new Set(['autofocus', 'autoplay', 'capture', 'checked', 'disabled', 'formnovalidate', 'hidden', 'loop', 'multiple', 'muted', 'novalidate', 'open', 'readonly', 'required', 'reversed', 'selected']);
...
function serializeAttributes(attributes) {
  return attributes.map(attr => attr.value.length ? `${attr.name}=${JSON.stringify(attr.value)}` : attr.name).join(' ');
}
