import { LwcConfig, ModuleRecord, NpmModuleRecord, DirModuleRecord, AliasModuleRecord, ModuleResolverConfig, RegistryEntry, InnerResolverOptions } from './types';
...
export declare function createRegistryEntry(entry: string, specifier: string, opts: InnerResolverOptions): RegistryEntry;
